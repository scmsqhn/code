...
# TODO 包名
from dmp.gongan.bj_crim_suspect_classify.gonganpred import criminalpredict
...
# TODO 修改URI
@app.route('/predict/110/suspectClassify', methods=['POST', 'GET'])
@log_service('作案人数', ['messageid', 'clientid', 'encrypt', 'text'])
