...
# TODO 包名
from dmp.gongan.sd_crim_jiesuofangshi_classify.gonganpred import criminalpredict
...
# TODO 修改URI
@app.route('/predict/sdst/jiesuofangshi', methods=['POST', 'GET'])
@log_service('解锁方式', ['messageid', 'clientid', 'encrypt', 'text'])
