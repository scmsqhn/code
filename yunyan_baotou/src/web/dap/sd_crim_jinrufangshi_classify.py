...
# TODO 包名
from dmp.gongan.sd_crim_jinrufangshi_classify.gonganpred import criminalpredict
...
# TODO 修改URI
@app.route('/predict/sdst/jinrufangshi', methods=['POST', 'GET'])
@log_service('进入方式', ['messageid', 'clientid', 'encrypt', 'text'])
