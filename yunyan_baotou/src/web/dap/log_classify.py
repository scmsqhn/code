...
from dmp.gongan.log_classsify_cluster.log_classify.classify_predict import classify_predict

child_sys_id = 'log_classify_cluster'
...
@app.route('/predict/log/classify', methods=['POST', 'GET'])
@log_service('日志分类聚类', ['messageid', 'clientid', 'encrypt', 'text'])
...
if __name__ == "__main__":
    app.run(host='0.0.0.0', debug=True, port=9987,
