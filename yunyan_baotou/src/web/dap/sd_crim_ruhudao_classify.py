...
# TODO 包名
from dmp.gongan.sd_crim_ruhudao_classify.gonganpred import criminalpredict
...
# TODO 修改URI
@app.route('/predict/sdst/ruhudao', methods=['POST', 'GET'])
@log_service('入户盗窃', ['messageid', 'clientid', 'encrypt', 'text'])
