...
# TODO 包名
from dmp.gongan.yn_crim_mobile_classify.gonganpred import criminalpredict


child_sys_id = 'ynmobile'
...
# TODO 修改URI
@app.route('/classify/burglary/mobile', methods=['POST', 'GET'])
@log_service('云南邢总手机盗窃', ['messageid', 'clientid', 'encrypt', 'text'])
