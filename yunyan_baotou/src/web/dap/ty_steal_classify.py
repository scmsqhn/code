...
# TODO 包名
from dmp.gongan.ty_steal_classify.gonganpred import criminalpredict as criminalpredict1

from dmp.gongan.ty_othersteal_classify.gonganpred import criminalpredict as criminalpredict2

os.environ["CUDA_VISIBLE_DEVICES"] = "-1"

child_sys_id = 'taiyuan'
...
# TODO 修改URI
@app.route('/classify/location-type/pq', methods=['POST', 'GET'])
@log_service('扒窃分类', ['messageid', 'clientid', 'encrypt', 'text'])
...
if __name__ == "__main__":
    app.run(host='127.0.0.1', debug=True, port=9998, use_reloader=True, threaded=True)
