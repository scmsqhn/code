...
# TODO 包名
from dmp.gongan.ty_crim_theft_classify.gonganpred import criminalpredict
...
# TODO 修改URI
@app.route('/classify/method-type/dq-five', methods=['POST', 'GET'])
@log_service('盗窃筛选扒窃', ['messageid', 'clientid', 'encrypt', 'text'])
