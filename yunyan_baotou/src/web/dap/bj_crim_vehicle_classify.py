...
# TODO 包名
from dmp.gongan.guangxi_crim_vehicle_classify.gonganpred import criminalpredict
...
# TODO 修改URI
@app.route('/predict/110/vehicleClassify', methods=['POST', 'GET'])
@log_service('作案车辆类型', ['messageid', 'clientid', 'encrypt', 'text'])
