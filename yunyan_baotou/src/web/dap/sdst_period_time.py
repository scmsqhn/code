...
# TODO 包名
from dmp.gongan.sdst_period_time.predict import ner_predict
...
# TODO 修改URI
@app.route('/ner/datetime/period-time', methods=['POST', 'GET'])
@log_service('山东案发时间段', ['messageid', 'clientid', 'encrypt', 'text'])
