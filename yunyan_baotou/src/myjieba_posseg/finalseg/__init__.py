...
from myjieba_posseg.finalseg.prob_start import P as start_P
from myjieba_posseg.finalseg.prob_trans import P as trans_P
from myjieba_posseg.finalseg.prob_emit import P as emit_P
