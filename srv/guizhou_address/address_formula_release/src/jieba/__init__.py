...
class Tokenizer(object):
    ...
    def calc(self, sentence, DAG, route):
        ...
        for idx in xrange(N - 1, -1, -1):
            ...
            print(DAG)
            for x in DAG[idx]:
                print("idx,x,DAG[idx]:",idx,x,DAG[idx])
                wd = sentence[idx:x+1]
                print("word is:", wd)
                xx_ = self.FREQ.get(wd)
                print("FREQ.get is:", xx_)
                print("log is:",xx_ or 1)
                print("add sub:",xx_ or 1 - logtotal + route[x+1][0])
                add_sub = log(xx_ or 1) - logtotal + route[x+1][0]
                print(add_sub,x)
                #pdb.set_trace()
            '''
