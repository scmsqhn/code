...
re_han_detail = re.compile("([\u4E00-\u9FD50-9a-zA-Z#&\._]+)")
re_han_internal = re.compile("([\u4E00-\u9FD5a-zA-Z0-9+#&\._]+)")
re_skip_detail = re.compile("([^\s\S])")
re_skip_internal = re.compile("([^\s\S])")

re_eng = re.compile("[^\s\S]")
re_num = re.compile("[^\s\S]")
re_eng1 = re.compile("[^\s\S]")
