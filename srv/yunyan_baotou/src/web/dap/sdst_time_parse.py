...
# TODO 包名
from dmp.gongan.sdst_time_parse.sdst_time_parse import ner_predict
...
# TODO 修改URI
@app.route('/ner/datetime/begin-end-time', methods=['POST', 'GET'])
@log_service('山东省厅开始时间和结束时间', ['messageid', 'clientid', 'encrypt', 'text'])
