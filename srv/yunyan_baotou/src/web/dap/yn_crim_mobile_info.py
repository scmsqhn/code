...
# TODO 包名
from dmp.gongan.yn_crim_mobile_info.yn_crim_mobile_info import predict_phone


child_sys_id = 'ynmobileinfo'
...
# TODO 修改URI
@app.route('/ner/items-involved/phone-info', methods=['POST', 'GET'])
@log_service('云南邢总手机信息提取', ['messageid', 'clientid', 'encrypt', 'text'])
def predict(param=None):
    ...
    predict_result = predict_phone(predict_str)
    result = {
