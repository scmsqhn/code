...
# TODO 包名
from dmp.gongan.bj_crim_loc_classify.gonganpred import criminalpredict
...
# TODO 修改URI
@app.route('/predict/110/region', methods=['POST', 'GET'])
@log_service('作案部位', ['messageid', 'clientid', 'encrypt', 'text'])
