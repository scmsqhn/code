...
# TODO 包名
from dmp.gongan.yn_case_money.moneyCount import ner_predict

child_sys_id = 'ynmoney'
...
# TODO 修改URI
@app.route('/ner/items-involved/amount', methods=['POST', 'GET'])
@log_service('云南涉案金额', ['messageid', 'clientid', 'encrypt', 'text'])
