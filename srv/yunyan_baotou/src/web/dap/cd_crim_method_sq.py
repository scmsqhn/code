...
from dmp.gongan.cd_crim_method_shuangqiang_classify.gonganpred import criminalpredict
...
@app.route('/predict/method/sq', methods=['POST', 'GET'])
...
def predict(param=None):
    ...
    out_result = criminalpredict(predict_str)
