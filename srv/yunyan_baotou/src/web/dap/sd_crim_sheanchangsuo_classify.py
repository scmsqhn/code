...
# TODO 包名
from dmp.gongan.sd_crim_sheanchangsuo_classify.gonganpred import criminalpredict
...
# TODO 修改URI
@app.route('/predict/sdst/sheanchangsuo', methods=['POST', 'GET'])
@log_service('涉案场所', ['messageid', 'clientid', 'encrypt', 'text'])
