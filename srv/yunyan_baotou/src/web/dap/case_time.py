...
# TODO 包名
from dmp.gongan.case_time.sdst_time_parse import ner_predict


child_sys_id = 'case_time'
...
# TODO 修改URI
@app.route('/ner/datetime/begin-end-casetime', methods=['POST', 'GET'])
@log_service('案发时间', ['messageid', 'clientid', 'encrypt', 'text'])
