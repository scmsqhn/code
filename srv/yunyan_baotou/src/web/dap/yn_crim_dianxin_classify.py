...
# TODO 包名
from dmp.gongan.yn_crim_dianxin_classify.gonganpred import criminalpredict


child_sys_id = 'yndxclassify'
...
# TODO 修改URI
@app.route('/classify/defraud/telegraphy', methods=['POST', 'GET'])
@log_service('云南邢总电信诈骗', ['messageid', 'clientid', 'encrypt', 'text'])
