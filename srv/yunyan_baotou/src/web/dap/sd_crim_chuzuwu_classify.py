...
# TODO 包名
from dmp.gongan.sd_crim_chuzuwu_classify.gonganpred import criminalpredict
...
# TODO 修改URI
@app.route('/predict/sdst/chuzuwu', methods=['POST', 'GET'])
@log_service('出租房屋', ['messageid', 'clientid', 'encrypt', 'text'])
