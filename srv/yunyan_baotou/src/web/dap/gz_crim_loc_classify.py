...
# TODO 包名
from dmp.gongan.gz_crim_loc_dq_classify.gonganpred import criminalpredict as dq_predict
from dmp.gongan.gz_crim_loc_qj_classify.gonganpred import criminalpredict as qj_predict
...
# TODO 修改URI
@app.route('/classify/location-type/dq', methods=['POST', 'GET'])
@log_service('贵阳盗窃部位', ['messageid', 'clientid', 'encrypt', 'text'])
...
# TODO 修改URI
@app.route('/classify/location-type/qj', methods=['POST', 'GET'])
@log_service('贵阳抢劫部位', ['messageid', 'clientid', 'encrypt', 'text'])
