...
from dmp.gongan.name_parse.predict import parse_name

child_sys_id = 'name parse'
...
# TODO 修改URI
@app.route('/predict/110/name_parse', methods=['POST', 'GET'])
@log_service('姓名解析', ['messageid', 'clientid', 'encrypt', 'text'])
