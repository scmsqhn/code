...
from dmp.gongan.gz_crim_type_classify.gonganpred import criminalpredict
...
@app.route('/type/predict', methods=['POST', 'GET'])
@log_service('命名实体提取', ['messageid', 'clientid','encrypt', 'text'])
...
if __name__ == "__main__":
    app.run(host='0.0.0.0', debug=True, port=7790, use_reloader=True, threaded=True)
