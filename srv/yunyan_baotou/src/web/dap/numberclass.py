...
# TODO 包名
from dmp.gongan.numbercalss.numbercalsspredict import numberpredict
...
# TODO 修改URI
@app.route('/predict/numberclass', methods=['POST', 'GET'])
@log_service('号码类型判断', ['messageid', 'clientid', 'encrypt', 'text'])
def predict(param=None):
    ...
    predict_result = numberpredict(predict_str)
    result = {
