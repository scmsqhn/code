...
from dmp.gongan.sd_110_address.predict import ner_predict as ner_addr_predict
...
@app.route('/predict/110/loc', methods=['POST', 'GET'])
@log_service('北京110', ['messageid', 'clientid', 'encrypt', 'text'])
def predict_name(param=None):
    ...
    predict_result = ner_addr_predict(predict_str,encrypt=encrypt)
...
if __name__ == "__main__":
    app.run(host='0.0.0.0', debug=True, port=22223, use_reloader=True, threaded=True)
