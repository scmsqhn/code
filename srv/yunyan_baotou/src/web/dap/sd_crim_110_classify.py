...
from dmp.gongan.shandong_crim_classify.gonganpred import criminalpredict
...
@log_service('山东110分类', ['messageid', 'clientid', 'encrypt', 'text'])
def predict(param=None):
    ...
    predict_result = criminalpredict(predict_str,encrypt=encrypt)
    result = {
