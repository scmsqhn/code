...
# TODO 包名
from dmp.gongan.sd_crim_kongjianbuwei_classify.gonganpred import criminalpredict
...
# TODO 修改URI
@app.route('/predict/sdst/kongjianbuwei', methods=['POST', 'GET'])
@log_service('空间部位', ['messageid', 'clientid', 'encrypt', 'text'])
