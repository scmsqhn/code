...
# TODO 包名
from dmp.gongan.sdst_wp_ner.predict import ner_precidt_wp
#/home/joe/ultraCode/iba/dap/sdst_wp_ner.py
...
# TODO 修改URI
@app.route('/ner/items-involved/items', methods=['POST', 'GET'])
@log_service('山东物品', ['messageid', 'clientid', 'encrypt', 'text'])
def predict(param=None):
    ...
    predict_result = ner_precidt_wp(predict_str)
    result = {
