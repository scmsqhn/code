...
from dmp.gongan.gz_crim_address_classify.gonganpred import criminalpredict_class_address
...
@app.route('/method/addrclassify', methods=['POST', 'GET'])
@log_service('地址分类[案发,户籍,居住]', ['messageid', 'clientid', 'encrypt', 'text'])
def addr_classify(param=None):
    # print(param)
